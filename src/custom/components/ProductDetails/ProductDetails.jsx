...
<div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className='opacity-50 text-sm'>234 Ratings </p>
            <p className='text-sm ml-3 font-medium text-indigo-600 hover:text-indigo-500'>654 Reviews</p>
            </div>
            </div>
    ...
    <div className='border p-5'>
        ...
        <Grid item xs={5}>
          ...
          <div className='flex items-center space-x-3'>
            ...
            <p className='opacity-60'>568990 Ratings</p>
          </div>
          <Box className="mt-5 space-y-3">
            ...
            <Grid container  alignItems="center" gap={2}>
              ...
              <Grid item xs={7}>
                <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}} variant='determinate' value={35} color='info'/>
              </Grid>
            </Grid>
            ...
            <Grid container  alignItems="center" gap={2}>
              ...
              <Grid item xs={7}>
                <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}} variant='determinate' value={28} color='primary'/>
              </Grid>
            </Grid>
            ...
            <Grid container  alignItems="center" gap={2}>
              ...
              <Grid item xs={7}>
                <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}} variant='determinate' value={23} color='error'/>
              </Grid>
            </Grid>
...
<section className='pt-10'>
  ...
  <div className='flex flex-wrap space-y-5 justify-center'>
    {mens_kurta.map((item)=><HomeSmallerCard product={item}/>)}
  </div>
</section>
